...
import com.boozdb.service.views.BottleListView;
import com.boozdb.service.views.BottleView;
import com.boozdb.service.views.HomeView;
...
public class BottleResourceView {
    ...
    {
        BoozDbMeta homePageData = bottleService.getBoozDbMetadata();
